...
import {
  ...
  CheckCircle, AlertCircle, Sparkles, Zap, Activity, DollarSign, Wallet,
  Building2, UserCircle, Heart, ShoppingCart, GraduationCap, Truck, Leaf, Cpu,
  Edit3, Camera, FileCheck, Eye, Plus, Upload, Download
} from 'lucide-react';
